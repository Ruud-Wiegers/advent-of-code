...
/**
 * Generates  the cartesian product of a list with itself, as a sequence of pairs
 */
fun <T> Iterable<T>.cartesian() = this.cartesian(this)

/**
 * Generates the cartesian product of a list with another list, as a sequence of pairs
 */
